...
std::optional<Se3Space::SE3Poses> Se3Space::InterpolatePath(const Eigen::Isometry3d& p1, const Eigen::Isometry3d& p2, double stepSize) const
{
    SE3Poses poses;
...
Eigen::Isometry3d Se3Space::interpolateSe3(const Eigen::Isometry3d& p1, const Eigen::Isometry3d& p2, double time) const
{
    Eigen::Vector3d v1 = p1.translation();
    Eigen::Vector3d v2 = p2.translation();
